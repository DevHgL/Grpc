...
class PubSubStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Publish = channel.unary_unary(
                ...
                response_deserializer=pubsub__pb2.PublishReply.FromString,
                _registered_method=True)
...
def add_PubSubServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Publish': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=pubsub__pb2.PublishReply.SerializeToString,
            ),
    }
...
class PubSub(object):
    ...
    def Publish(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            pubsub__pb2.PublishReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
